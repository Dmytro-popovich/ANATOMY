...
(function () {
  const coursePromo = document.querySelector('.course-promo');
  if (!coursePromo) return;
  ...
  cta.innerHTML = `
    <a class="btn btn--primary" href="https://instagram.com/dari_permanent" target="_blank" rel="noopener">Reserve via Instagram</a>
